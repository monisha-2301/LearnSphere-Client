...
import CourseCertificate from '../../core/Course/CourseCertificate';
          ...
          {enrolledCourses?.map((course, i, arr) => (
            ...
            >
              ...
              <div className="sm:hidden w-full">
                <div className="px-5 py-3">{course?.totalDuration}</div>
              ...
              {/* Desktop view */}
              <div className="hidden sm:flex w-1/4 px-5 py-3">{course?.totalDuration}</div>
              <div className="hidden sm:flex flex-1 flex-col gap-2 px-5 py-3">
                <p>Progress: {course.progressPercentage || 0}%</p>
                <ProgressBar
                  completed={course.progressPercentage || 0}
                  height="8px"
